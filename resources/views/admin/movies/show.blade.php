...
<div class="card W_1">
    <img class="C_img" src="{{$movie->thumb}}" alt="">
...
<div class="container">
        ...
        <div class="col-8">
            <div class="row bg_green d-flex align-items-center">
                ...
                <div class="col-10 justify-content-between d-flex align-items-center">
                    <p><span class="green">U.S. Price:</span>{{$movie->price }}</p>
    ...
    <a class="btn btn-primary" href="{{route('movies.edit', $movie->id)}}"><i class="fas fa-edit"></i></a>
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <div class="B_B d-flex justify-content-around ">
                <p class="BL">Series:</p><span class="and U">{{$movie->series}}</span>

            </div>
            <div class=" B_B d-flex justify-content-around ">
                <p class="BL">U.S. Price:</p><span>{{$movie->price}}</span>
            </div>
            <div class=" B_B d-flex justify-content-around ">
